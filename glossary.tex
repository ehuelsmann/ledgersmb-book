...
\newglossaryentry{accounting year}{
	...
	description={\index{accounting year}An accounting year, which may also be called fiscal year, financial year or budget year
...
\newglossaryentry{gifi}{
    name={GIFI},
    description={\index{GIFI}Stands for Generalized Index for Financial Information,
...
\newglossaryentry{ISO20022}{
    name={ISO-20022},
    description={\index{ISO-20022}ISO 20022 is a multi part International Standard prepared by ISO Technical Committee 
...
\newglossaryentry{oldcode}{
    name={old code},
    description={\index{old code}Stands for the code inherited from SQL Ledger at the time
...
\newglossaryentry{payment}{
    ...
    description={A transfer of cash or cash equivalents out of the company. 
        Payments are not \glspl{expense}: e.g. payments to pay off a loan}}
