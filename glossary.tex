...
\newglossaryentry{reporting units}{
	name={reporting units},
	description={Reporting units are primarily used to divide sales and purchase reporting into departments, jobs, projects, etc.}}
