...
Reporting unit classes can be created (added), modified or deleted through the \menupath{System \ma Reporting Units} menu item. Reporting units can be created and modified using the same menu item.  Reporting units have start and end dates, but may not be deleted to insure financial integrity.
...
\begin{longtable}{ llp{6cm} }
	...
	Start Date &  The active transaction start date\\
	End Date &  the active transaction end date\\
