...
Most new LedgerSMB setups start with one of the predefined Chart of Accounts and add or delete as necessary to customize it for their business.
...
\begin{description}[style=nextline]
    ...
    \item[Tax] This checkmark identifies the account as a Tax (VAT)\index{tax} account. Tax accounts need
