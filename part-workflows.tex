...
\item [Class] The type of company; vendor, customer, etc.
...
\begin{description}[style=nextline]
	\item [Class] @@@TODO
\item [Number] Number to identify this account among all other accounts in the company;
...
\item [Account] Account (AR) to post created invoices on
\item [AP] Account used as default to accept payments on
\item [Payment]
...
\menupath{Cash \ma Reconcillation}
