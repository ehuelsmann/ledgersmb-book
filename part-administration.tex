...
The database backups can be created through the \texttt{setup.pl} web interface.  The
database content backup can also be created using the \texttt{ledgersmb-admin} administration
command line tool.
...
upgraded in order to become compatible with the new software.  This upgrade is
