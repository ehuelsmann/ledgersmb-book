...
\item [Last cost] Last buying price (@@@ updated when creating new vendor invoices???)
...
\item [On hand - ROP] Reorder point - when the inventory drops below this number,
     the part will show up in ``Short parts'' reports
\item [On hand - Bin] The storage location in the warehouse
\end{itemize}
...
\begin{itemize}
\item [Sell price]
\item [From] (@@@ inclusive or exclusive?)
\item [To] (@@@ inclusive or exclusive?)
\end{itemize}
