...
An examples are ``is the posting date of the transaction in a closed period''
...
the standard location \texttt{./workflows}.  No changes should be made directly to
the standard files because of the risk that those files will be overwritten on upgrade
-- loosing the changes.
