...
The book has been split up in several parts, each with their own intended audience. With
parts intended for young entrepreneurs, (potential) users, application integration developers and
