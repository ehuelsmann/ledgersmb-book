...
This section is deprecated as of 1 Jan 2023 and only remains for historical use.
...
\begin{description}[style=nextline]
	...
	reason
	\item[language] @@@TODO
	\item[log\_level] @@@TODO
	\item[DBI\_TRACE] @@@TODO
	\item[pathsep] @@@TODO
...
\begin{description}[style=nextline]
	...
	\item [templates] @@@TODO
	\item [images] @@@TODO
	\item [memberfile] @@@TODO
	\item [localepath] @@@TODO
\end{description}
...
\begin{description}[style=nextline]
	\item [sendmail] @@@TODO
	\item [smtphost] @@@TODO
	\item [smtptimeout] @@@TODO
	\item [backup\_email\_from] @@@TODO
\end{description}
